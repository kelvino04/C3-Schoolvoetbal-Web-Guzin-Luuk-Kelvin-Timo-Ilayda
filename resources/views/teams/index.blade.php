    ...
    <div class="py-12">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <div class="flex justify-end mb-4">
                <a href="{{ route('teams.create') }}" class="inline-flex items-center px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                    Create Team
                </a>
            </div>
                                    ...
                                    @foreach($teams as $team)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 flex gap-2">
                                                <a href="{{ route('teams.edit', $team->id) }}" class="bg-yellow-500 text-white px-2 py-1 rounded">Edit Team</a>
                                                <a href="{{ route('players.index', $team->id) }}" class="bg-green-600 text-white px-2 py-1 rounded">Players</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th data-sort class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                            Creator<span class="sort-arrow">⇅</span>
                                        </th>
                                        <th data-sort class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($allTeams as $team)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">{{ $team->creator->name ?? 'Unknown' }}</td>
            ...
            @if(auth()->user()->role === 'admin')
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Admin: Manage All Teams</h3>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-right flex gap-2">
                                                ...
                                                <form method="POST" action="{{ route('teams.destroy', $team) }}" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="bg-red-600 text-white px-2 py-1 rounded" onclick="return confirm('Delete this team?')">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
